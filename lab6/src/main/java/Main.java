...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Boat boat = new Boat("USA",221.2,5,SportType.KIAYKI,5,6,8);
        ...
        equipmentWriter.writeToFile(list);
        ...
        do {
            ...
            switch (num) {
                ...
                case 2: {
                    System.out.println(equipManager.findBySportType(list,SportType.KIAYKI));
                    break;
                }
                case 3: {
